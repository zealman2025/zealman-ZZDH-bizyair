...
调用 BizyAir API，在字字动画内以约 2～5 分钱/张的成本，调用 GPT-Image-2 文生图 / 图生图与 NanoBanana 2 文生图 / 图生图。
...
| **NanoBanana 2 文生图 / 图生图（第三方）** | 1K | **200** | ≈ **4 分钱** |
| **NanoBanana 2 文生图 / 图生图（第三方）** | 2K | **200** | ≈ **4 分钱** |
| **NanoBanana 2 文生图 / 图生图（第三方）** | 4K | **250** | ≈ **5 分钱** |
